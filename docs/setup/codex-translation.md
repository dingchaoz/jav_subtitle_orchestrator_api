...
It runs the checked-in Codex-based batch translator:

```text
scripts/translate_srts.py
```
...
```text
python3 scripts/translate_srts.py --source-root <directory> --output-root <directory> ...
```
